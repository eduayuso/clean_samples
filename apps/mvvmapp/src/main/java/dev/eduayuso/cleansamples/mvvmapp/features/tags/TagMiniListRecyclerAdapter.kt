...
import dev.eduayuso.cleansamples.mvvmapp.databinding.ItemTagMiniBinding
...
private val listener: OnTagClickListener
    ...
    override fun onCreateViewHolder(parent: ViewGroup, i: Int): ListViewHolder {
        ...
        val listItemBinding = ItemTagMiniBinding
            .inflate(LayoutInflater.from(parent.context), parent, false)
        return ListViewHolder(listItemBinding)
    }

    inner class ListViewHolder(private val boundItem: ItemTagMiniBinding):
